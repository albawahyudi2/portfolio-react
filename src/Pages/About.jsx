      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
             Seorang mahasiswa Sistem Informasi yang berfokus pada pengembangan Full-Stack Web dan rekayasa perangkat lunak. Memiliki rekam jejak dalam membangun sistem berskala instansi pemerintahan, saya memadukan keahlian merancang antarmuka (UI/UX) yang intuitif dengan arsitektur backend yang tangguh dan aman. Saya selalu tertantang untuk menghadirkan solusi digital yang efisien, skalabel, dan berdampak nyata bagi penggunanya.
            </p>
