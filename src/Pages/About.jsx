...
const AboutPage = () => {
  ...
  const statsData = useMemo(() => [
    ...
    },
    {
      ...
      description: "Academic Excellence Demonstrated",
      animation: "fade-up",
    },
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
             Seorang mahasiswa Sistem Informasi yang memiliki ketertarikan besar pada pengembangan Front-End dan UI/UX. Saya berfokus pada perancangan antarmuka yang intuitif, menarik, dan berorientasi pada pengalaman pengguna, serta selalu berusaha memberikan solusi digital terbaik dalam setiap proyek yang saya kerjakan.
            </p>
