...
const TRANSKRIP_PDF = "/pdf/Transkrip%20Mahasiswa.pdf";
...
const projects = [
  ...
  },
  {
    ...
    desc: "Sertifikat pengalaman magang di Kementerian Komunikasi dan Informatika",
    file: "/pdf/sertifikat%20magang.pdf",
  },
  {
    type: "pdf",
    title: "Lembar Penilaian Magang - Diskominfo",
    desc: "Rekapitulasi nilai dan penilaian performa magang di Dinas Komunikasi dan Informatika.",
    file: "/pdf/transkrip magang.pdf",
  },
];
        ...
        "
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                  ...
                  <div className="bg-white/5 rounded-xl p-4">
                    ...
                    <p className="text-green-400 font-bold text-xl">3.46</p>
                  </div>
                </div>
